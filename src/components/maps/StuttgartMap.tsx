...
const cityCenters: Record<string, { center: [number, number]; zoom: number }> = {
  ...
  'Hamburg': { center: [53.5511, 9.9937], zoom: 12 },
  'Köln': { center: [50.9375, 6.9603], zoom: 12.5 },
  'Düsseldorf': { center: [51.2277, 6.7735], zoom: 12.5 },
  'Leipzig': { center: [51.3397, 12.3731], zoom: 12.5 },
  'Dortmund': { center: [51.5136, 7.4653], zoom: 12.5 },
  'Essen': { center: [51.4556, 7.0116], zoom: 12.5 },
  'Bremen': { center: [53.0793, 8.8017], zoom: 12.5 },
  'Dresden': { center: [51.0504, 13.7373], zoom: 12.5 },
  'Hannover': { center: [52.3759, 9.7320], zoom: 12.5 },
  'Nürnberg': { center: [49.4521, 11.0767], zoom: 12.5 },
  'Duisburg': { center: [51.4344, 6.7623], zoom: 12.5 },
  'Bochum': { center: [51.4818, 7.2162], zoom: 12.5 },
  'Wuppertal': { center: [51.2562, 7.1508], zoom: 12.5 },
  'Bielefeld': { center: [52.0302, 8.5325], zoom: 12.5 },
  'Bonn': { center: [50.7374, 7.0982], zoom: 12.5 },
  'Münster': { center: [51.9607, 7.6261], zoom: 12.5 },
  'Mannheim': { center: [49.4875, 8.4660], zoom: 12.5 },
  'Karlsruhe': { center: [49.0069, 8.4037], zoom: 12.5 },
  'Augsburg': { center: [48.3705, 10.8978], zoom: 12.5 },
