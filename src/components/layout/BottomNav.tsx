            ...
            if (isCenter) {
              return (
                <button
                  ...
                  className="relative -mt-6 flex flex-col items-center gap-1 transition-all duration-200"
                >
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-primary to-accent shadow-neon-purple transition-transform hover:scale-110 active:scale-95">
